...
/*
 *	@(#)sysinfo_depend.h (sys/RZT1) 2016/07/22
 *
...
#define SCArea	( (SysCommonArea*)0x00003c00 )
#define SCInfo	( SCArea->scinfo )

#endif /* _in_asm_source_ */

/* Definitions used by assembler */
#define TASKINDP	(0x00004400 + 4*4)	/* Task independent flag */
#define TASKMODE	(0x00004400 + 5*4)	/* Task mode flag */

/*
 * Vector table address
 */
#define EIT_VECTBL	0x00003C00	/* Vector table top */
...
#|* 2016/07/22	EIT_VECTBLを0x0003C00～とし、N_INTVECを256→512に拡張
#|
*/
