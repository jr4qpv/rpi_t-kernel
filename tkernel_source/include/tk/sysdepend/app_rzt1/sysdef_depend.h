...
/*
 *	@(#)sysdef_depend.h (tk/RZT1)
 *
 *	Definition about RZT1
 *
...
/* ------------------------------------------------------------------------
#|History of "sysdef_depend.h"
#|============================
#|* 2016/06/02	It's copied from "../tef_em1d/" and it's modified.
#|* 2016/06/02	ISB,DSB,DMB命令を使うように修正。
#|
*/
