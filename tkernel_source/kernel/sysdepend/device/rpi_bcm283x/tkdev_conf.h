...
/*
 *	@(#)tkdev_conf.h (BCM283x) 2016/07/21
...
#define	VECNO_TIMER	( EIT_IRQ(64) )	/* interrupt vector number */
...
/*----------------------------------------------------------------------
#|History of "tkdev_conf.h"
#|=======================
#|* 2016/07/21	[rpi_bcm283x]用に、[tef_em1d]用の"tkdev_conf.h"を参考に作成。
#|
*/
