...
#define _ALIGN_CPU(x)	(((x)+7)&0xFFFFFFF8)	/* BCM283x : 8byte align */
...
#|History of "offset.h"
#|=======================
#|* 2016/07/19	[rpi_bcm283x]用に、[tef_em1d]用の"offset.h"を参考に作成。
#|* 2016/07/19	_ALIGN_CPUマクロを、4byte境界→8byte境界に記述変更
#|
*/
