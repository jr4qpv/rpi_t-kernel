...
///#define	PAGETBL_BASE	(_UW *)0x30000000
	...
	void (* volatile reset_p)( void ) = _start;
...
#if 1
	while (1) { /* wait WDT reset */ }		/* reset (does not return) */
#else
...
/*----------------------------------------------------------------------
#|History of "reset-sh4.c"
#|=========================
#|* 2016/01/21	It's copied from "setup-em1d.c" and it's modified.
#|
*/
