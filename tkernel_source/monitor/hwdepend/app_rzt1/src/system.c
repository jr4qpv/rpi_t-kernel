...
IMPORT	char	interrupt_entry_1;	/* interrupt entry area address */
///IMPORT	MEMSEG	NoMemSeg[];	/* memory unused area */
///IMPORT	W	N_NoMemSeg;


/* initialize VIC VAD register */
LOCAL	void	vicvadInit(void)
{
	int i;
	_UW	*vad;
	UW	ad;
...
#|History of "system.c"
#|=====================
#|* 2016/03/14	It's copied from "../tef_em1d/" and it's modified.
#|* 2016/07/18	RZT1ópÇ…vicvadInit()èàóùÇÃí«â¡ÅB
#|
*/
