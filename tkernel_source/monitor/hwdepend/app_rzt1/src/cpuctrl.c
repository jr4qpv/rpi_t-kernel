 ...
 *----------------------------------------------------------------------
 *
 *    Modified by T.Yokobayashi at 2016/04/19.
 *
 *----------------------------------------------------------------------
 */

/*
 *	@(#)cpuctrl.c () 2016/04/19
 *
 *       ARM CPU control
 */
...
/* ------------------------------------------------------------------------
#|History of "cpuctrl.c"
#|====================
#|* 2016/04/19	It's made by making reference to "cpuctrl.c" for [tef_em1d].
#|* 2016/04/19	TopPageTableは、PAGETBL_BASEが定義されてる時に有効とした
#|
*/
