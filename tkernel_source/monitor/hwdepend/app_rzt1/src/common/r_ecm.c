...
*              : 29.02.2016 1.2A     Second Release
...
#|* 2016/04/08	(void)dummy_8;行を追加して、警告を出さないようにした。
#|* 2016/04/08	(void)dummy_32;行を追加して、警告を出さないようにした。
#|
#endif
