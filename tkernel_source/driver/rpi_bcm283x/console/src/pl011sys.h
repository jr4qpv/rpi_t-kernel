...
/*
 *	@(#)pl011sys.h	Console/Low-level serial I/O driver (BCM283x) 2016/08/03
 *
 ...
 *	"UART" clock
 */
#define	UART_CLK	(UART0_CLOCK)		/* 3MHz */
...
/*----------------------------------------------------------------------
#|History of "pl011sys.h"
#|=======================
#|* 2016/07/25	It's made by making reference to "ns16450sys.h" for [tef_em1d].
#|
*/
