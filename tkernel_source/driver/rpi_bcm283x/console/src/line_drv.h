 ...
 *----------------------------------------------------------------------
 *
 *    Modified by T.Yokobayashi at 2016/07/29.
 *
 *----------------------------------------------------------------------
 */
...
typedef struct _L_INFO {
	...
	UW	lsts;		/* Current line error status */
	UW	lstshist;	/* Line error history status */
	UW	msts;		/* Current modem status */
...
#|=======================
#|* 2016/07/29	It's made by making reference to "line_drv.h" for [tef_em1d].
#|* 2016/07/29	lsts,lstshist,mstsの型をUB→UWに変更
#|
*/
