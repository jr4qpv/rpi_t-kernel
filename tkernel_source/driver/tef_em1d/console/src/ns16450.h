...
/*
 *	ns16450.h	Console/Low-level serial I/O driver
 *
...
#define	SC_INTS		_IOADR(2)	/* Interrupt ident register	R   */
...
#define	SC_DIVL		_IOADR(9)	/* Freq dividing count lower	R/W */
#define	SC_DIVH		_IOADR(10)	/* Freq dividing count upper	R/W */
#else
#define	SC_DATA		_IOADR(0)	/* Data register		R/W */
#define	SC_INTE		_IOADR(1)	/* Interrupt-enabled register	R/W */
#define	SC_INTS		_IOADR(2)	/* Interrupt ident register	R   */
...
#define	SC_DIVL		_IOADR(0)	/* Freq dividing count lower	R/W */
#define	SC_DIVH		_IOADR(1)	/* Freq dividing count upper	R/W */
#endif
...
#define	LS_RFER		0x80		/* Error in the receive FIFO */
...
#define	MC_OUT2		0x08		/* User-specified aux output #2 */
#define	MC_OUT1		0x04		/* User-specified aux output #1 */
...
#define	IS_CTMO		0x0c		/* ID=6 char time-out interrupt */
#define	IS_LSTS		0x06		/* ID=3 rcv-line status interrupt */
