 ...
 *----------------------------------------------------------------------
 *
 *    Modified by T.Yokobayashi at 2016/01/07.
 *
 *----------------------------------------------------------------------
 */
...
#define	MMC_DRV_USE	0					///////// MMCドライバ未使用 ////////
...
#if 0
#|【main.c 変更履歴】
#|□2016/01/07	[app_sh7760]用に、[tef_em1d]の"main.c"を参考に作成。
#|□2016/02/03	条件コンパイル｢MMC_DRV_USE｣でMMC関係処理を除外。
#|
#endif
